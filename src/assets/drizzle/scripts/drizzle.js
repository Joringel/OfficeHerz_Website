...
require('./_set-navigation-status.js');
require('./_toggle-details.js');
require('./_masonry.js');
...
//dom.navItemCollapse.addEventListener('click', event => {
//  event.preventDefault();
//    console.log('Click');
//  dom.navItemCollapse.classList.toggle('is-active');
//});
